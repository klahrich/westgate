...
from westgate.feature_eng import FeatureEng, BasicFeatureEng
import logging
...
class LendingModel:
    ...
    def __init__(self, experiment_id:str, basefolder='./', ylabel=''):
        ...
        self.features = None
        self.feature_engs = []
        self.add_feature_eng(BasicFeatureEng())
        self.automl = None
    ...
    def add_feature_eng(self, fe:FeatureEng):
    ...
    def feature_engineer(self, X_train, X_test=None):
        ...
        for fe in self.feature_engs:
            X_train = fe.feature_engineer(X_train)
        ...
        if X_test is not None:
            for fe in self.feature_engs:
                X_test = fe.feature_engineer(X_test)
